...
<template>
    <div
        role="status"
        class="max-w-full animate-pulse rounded-sm border border-gray-200 p-4 shadow-sm md:p-6 dark:border-gray-700">
        <div class="mb-4 flex h-48 items-center justify-center rounded-sm bg-gray-300 dark:bg-gray-700">
            <svg
