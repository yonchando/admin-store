            ...
            <div class="row">
                <div class="col-6">
                    <div class="tw-space-y-3">
                        ...
                        <ListItem
                            :label="lang.gender"
                            :value="customer.gender_text"
                        />
                        <ListItem
                            :label="lang.total_purchase"
                            :value="customer.purchase_orders_count"
                        />
                    </div>
                </div>
            </div>
        ...
        <Card :title="lang.purchase_orders">
            <Table>
                ...
                <template v-if="customer.purchase_orders.length > 0">
                    <tr
                        v-for="(purchase, i) in customer.purchase_orders"
                        :key="purchase.id"
                    >
                        <td>{{ i + 1 }}</td>
                        <td>
